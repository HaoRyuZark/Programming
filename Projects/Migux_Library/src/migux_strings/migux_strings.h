...
#define s_check_null_return(ptr, msg) \
...
#define s_check_allocation_of_inner_char_buffer_return(ptr) \
    do { if (ptr == NULL) { free(ptr); fprintf(stderr, "%s", S_ERR_STR_NULL); return; } } while (0)
