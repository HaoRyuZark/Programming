...
insert into
    ami_kemper.Studenten (MatrNr, Name, Semester)
...
insert into
    ami_kemper.hoeren (MatrNr, VorlNr)
values (25403, 5022),
    (26120, 5001),
    (27550, 4052),
    (27550, 5001),
...
insert into
    ami_kemper.pruefen (MatrNr, VorlNr, PersNr, Note)
...
insert into
    ami_kemper.voraussetzen (Vorgaenger, Nachfolger)
values (5001, 5041),
    (5001, 5043),
    (5001, 5049),
    (5041, 5052),
