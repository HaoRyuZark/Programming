...
Different tools use YAML in with different definitions, this means that each tool has its own schema for the configuration which needs 
to be checked before writting the configuration.
