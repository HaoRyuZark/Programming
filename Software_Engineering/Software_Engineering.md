...
These are the two main ways of processing data generated by an application.

- **Batch**: Data is stored over a certain period and the processed. Like for example the total sales of a day.

- **Stream**: Data is constantly fetched and processed on real time. Every trackable interaction of a user on website.
