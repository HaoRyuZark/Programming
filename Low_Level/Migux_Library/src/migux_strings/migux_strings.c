...
string* create_empty_string(void) {
    ...
    s_check_allocation_of_inner_char_buffer_return_NULL(self->str);
...
string* create_string_from(const char* str) {
    ...
    s_check_null_return_null(str, "string: input string is NULL\n");
...
string* create_string_from_c_string(const string* other) {
    ...
    s_check_null_return_null(other, S_ERR_SELF_NULL);
...
string* get_substring(const string* self, size_t start, size_t end) {
    ...
    return create_string_from_with_len(self->str + start, end - start);
}
...
void concatenate_c_strings(string* self, const string* other) {
    ...
    s_check_null_return_void(self,  S_ERR_SELF_NULL);
    s_check_null_return_void(other, S_ERR_SELF_NULL);
...
void concatenate_c_string_and_native_string(string* self, const char* other, size_t other_size) {
    ...
    s_check_null_return_void(self,  S_ERR_SELF_NULL);
    s_check_null_return_void(other, S_OTHER_NULL);
